...
public struct GenerationOptions: Sendable, Equatable, Codable {
    ...
    public struct ToolCallingMode: Sendable, Equatable, Codable {
        ...
        public static var allowed: ToolCallingMode {
            ToolCallingMode(kind: .allowed)
        }

        public static var required: ToolCallingMode {
            ToolCallingMode(kind: .required)
        }

        public static var disallowed: ToolCallingMode {
            ToolCallingMode(kind: .disallowed)
        }
    }
    ...
    ///   - maximumResponseTokens: The maximum number of tokens the model is allowed
    ///     to produce before being artificially halted. Must be positive.
    ///   - toolCallingMode: The tool calling mode to use.
    public init(
